...
To create a config.yaml specific to your user, do `connect-demo/create_config.sh`. This will create a config.yaml file in the python/utils directory with the correct paths and configurations.
